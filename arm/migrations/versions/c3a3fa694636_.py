...
def upgrade():
    ...
    sa.Column('RAW_PATH', sa.String(length=255), nullable=True),
    sa.Column('TRANSCODE_PATH', sa.String(length=255), nullable=True),
    sa.Column('COMPLETED_PATH', sa.String(length=255), nullable=True),
